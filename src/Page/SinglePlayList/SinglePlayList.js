...
import {deleteVideoFromPlaylist} from "./../../services/index"
...
const SinglePlayList = () => {
  ...
  const deleteVideoHandler = (_id) => {
      console.log(id,"id");
      console.log(_id, token, PlayListDispatch,"uiyri");

    deleteVideoFromPlaylist(_id,id, token, PlayListDispatch)
